...
public class ElementOperationDepositSpending extends LinearLayout {
    ...
    public ElementOperationDepositSpending(Context context) {
        super(context);
        inicialize();
        this.context = context;
    }

    public ElementOperationDepositSpending(Context context, AttributeSet attrs) {
        super(context, attrs);
        inicialize();
        this.context = context;
    }
