...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        UserLoginTask(String email, String user, String password) {
            //mEmail = email;
            //mPassword = password;
            mUser = new User(user,password,email);
        }
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            User user = UsersDB.getUserByNameEmail(getBaseContext(),mUser.getUserName(),mUser.getEmail());
            if(user != null){
            ...
            UsersDB.insertUser(getBaseContext(),mUser);
